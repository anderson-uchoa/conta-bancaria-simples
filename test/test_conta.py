...
class TestConta(unittest.TestCase):
    ...
    def test_criarConta(self):
        ...
        self.assertEqual(100, self.conta.getNumero(), 0.01, "O valor do limite padrao de uma conta 100")
        self.assertEqual(2100, self.conta.getNumero(), 0.01, "O saldo deve ser igual ao limite + o saldo")

        conta = Conta(1010, 1000)
        self.assertEqual(1010, conta.getNumero(), "O numero da conta deve igual ao informado na criacao")
        self.assertEqual(100, conta.getNumero(), 0.01, "O valor do limite padrao de uma conta 100")
        self.assertEqual(1100, conta.getNumero(), 0.01, "O saldo deve ser igual ao limite + o saldo")

    def test_varificarSaldo(self):
        self.assertEqual(2100, self.conta.getSaldo(), 0.01, "O saldo deve ser igual ao limite + o saldo")
    ...
    def test_usuarioNaoPodeRealizarSaquesNegativos(self):
        ...
        self.assertEqual(2100, self.conta.getSaldo(), 0.01, "O saldo deve permanecer inalterado")
    ...
    def test_usuarioPodeSacarValoresUtilizandoOLimite(self):
        ...
        self.assertEqual(50, self.conta.getSaldo(), 0.01, "Valor sacado maior que o saldo")
        self.assertEqual(50, self.conta.getLimite(), 0.01, "O limite foi utilizado na operacao")
    ...
    def test_usuarioPodeSacarValoresSemUtilizarLimite(self):
        ...
        self.assertEqual(1100, self.conta.getSaldo(), 0.01, "Valor sacado maior que o saldo")
        self.assertEqual(100, self.conta.getLimite(), 0.01, "O limite nao foi utilizado na operacao")
    ...
    def test_usuarioPodeDepositarValoresPositivos(self):
        ...
        self.assertEqual(3000, self.conta.getSaldo(), 0.01, "O saldo nao atualizado corretamente")
    ...
    def test_depositosEmContasComLimiteUtilizadoDevemRestaurarOLimite(self):
        ...
        self.assertEqual(50, self.conta.getSaldo(), 0.01, "O saldo nao atualizado corretamente")
        self.assertEqual(50, self.conta.getLimite(), 0.01, "Limite nao restaurado")

        self.assertTrue(self.conta.depositar(100), "Depositar valores positivos sao permitidos")
        self.assertEqual(150, self.conta.getSaldo(), 0.01, "O saldo nao atualizado corretamente")
        self.assertEqual(100, self.conta.getLimite(), 0.01, "Limite nao restaurado")
    ...
    def test_usuarioNaoPodeTransferirQuantiasMaioresQueOSaldo(self):
        ...
        self.assertEqual(2100, self.conta.getSaldo(), 0.01, "O saldo deve permanecer inalterado")
        self.assertEqual(100, destino.getSaldo(), 0.01, "O saldo deve permanecer inalterado")
    ...
    def test_usuarioPodeTransferirQuantiasUtilizandoLimite(self):
        ...
        self.assertEqual(50, self.conta.getSaldo(), 0.01, "Valor sacado maior que o saldo")
        self.assertEqual(50, self.conta.getLimite(), 0.01, "O limite foi utilizado na operacao")
        self.assertEqual(2150, destino.getSaldo(), 0.01, "O saldo deve permanecer inalterado")
    ...
    def test_usuarioPodeTransferirQuantiasSemUsarLimite(self):
        ...
        self.assertEqual(1100, self.conta.getSaldo(), 0.01, "Valor sacado maior que o saldo")
        self.assertEqual(100, self.conta.getLimite(), 0.01, "O limite nao foi utilizado na operacao")
        self.assertEqual(1100, self.conta.getSaldo(), 0.01, "O saldo deve permanecer inalterado")
